...
private:
	static void LoadMaterial(wstring matFolder, wstring matFile, vector<Material *>* materials);
	static void ReadMaterialData(wstring matFolder, wstring matFile);

	static void LoadMesh(wstring MeshFolder, wstring MeshFile, vector<class ModelBone *>* bones, vector<class ModelMesh *>* meshes);
	static void ReadMeshData(wstring MeshFolder, wstring MeshFile);
